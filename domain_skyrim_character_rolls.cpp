...
const BirthSignsRollList& getBirthSignsRollList()
{
	...
	static const auto list
		= BirthSignsRollList{
			BirthSignsRollMatcher(Domain::Range(1, 8), ritual),
...
Gender rollGender()
{
	...
	if (!isTrans)
	{
		return genderAssignmentId == amab
			       ? Gender(male, "Man", isTrans, genderAssignmentId)
...
const RaceRollList& getRaceRollList()
{
	static const auto nord
		= Race{
			...
			SkinColorRollList{
				createSkinColorMatcher(Domain::Range(1, 70), sc_pale),
				createSkinColorMatcher(Domain::Range(71, 95), sc_fair),
				createSkinColorMatcher(Domain::Range(96, 100), sc_tan)
			},
			HairColorRollList{
				createHairColorMatcher(Domain::Range(1, 60), hc_blonde),
			...
			EyeColorRollList{
				createEyeColorMatcher(Domain::Range(1, 50), ec_blue),
	...
	static const auto imperial
		= Race{
			...
			HairColorRollList{
				createHairColorMatcher(Domain::Range(1, 40), hc_brown),
			...
			EyeColorRollList{
				createEyeColorMatcher(Domain::Range(1, 60), ec_brown),
	...
	static const auto breton
		= Race{
			...
			EyeColorRollList{
				createEyeColorMatcher(Domain::Range(1, 40), ec_blue),
	...
	static const auto redguard
		= Race{
			...
			HairColorRollList{
				createHairColorMatcher(Domain::Range(1, 70), hc_black),
	...
	static const auto bosmer
		= Race{
			...
			HairColorRollList{
				createHairColorMatcher(Domain::Range(1, 60), hc_brown),
			...
			EyeColorRollList{
				createEyeColorMatcher(Domain::Range(1, 60), ec_green),
				createEyeColorMatcher(Domain::Range(61, 80), ec_hazel),
	...
	static const auto khajiit
		= Race{
			...
			HairColorRollList{
				createHairColorMatcher(Domain::Range(1, 30), hc_brown),
			...
			EyeColorRollList{
				createEyeColorMatcher(Domain::Range(1, 40), ec_amber),
				createEyeColorMatcher(Domain::Range(41, 70), ec_green),
	...
	static const auto argonian
		= Race{
			...
			EyeColorRollList{
				createEyeColorMatcher(Domain::Range(1, 40), ec_yellow),
			...
			HornTypeRollList{
				createHornTypeMatcher(Domain::Range(1, 35), ht_none),
	...
	static const auto list = RaceRollList{
		RaceRollMatcher(Domain::Range(1, 42), nord),
...
const OccupationRollList& getOccupationRollList(const Race& race, const Archetype& archetype)
{
	...
	static const auto vigilant = Occupation(oc_vigilant, "Vigilant of Stendarr");
	...
	static const auto redoranGuard = Occupation(oc_redoran_guard, "Redoran Guard");
	static const auto bountyHunter = Occupation(oc_bounty_hunter, "Bounty Hunter");
	static const auto ashlander = Occupation(oc_ashlander, "Ashlander");
	static const auto cityGuardRiften = Occupation(oc_city_guard_riften, "City Guard (Riften)");
	static const auto treasureHunter = Occupation(oc_treasure_hunter, "Treasure Hunter");
	static const auto moragTong = Occupation(oc_morag_tong, "Morag Tong");
	static const auto houseWizard = Occupation(oc_house_wizard, "House Wizard");
	static const auto thalmorSoldier = Occupation(oc_thalmor_soldier, "Thalmor Soldier");
	static const auto explorer = Occupation(oc_explorer, "Explorer");
	static const auto thalmorAgent = Occupation(oc_thalmor_agent, "Thalmor Agent");
	static const auto thalmorWizard = Occupation(oc_thalmor_wizard, "Thalmor Wizard");
	static const auto aspiringCultist = Occupation(oc_aspiring_cultist, "Aspiring Cultist");
	static const auto summersetScholar = Occupation(oc_summerset_scholar, "Summerset Scholar");
	static const auto orsiniumExtremist = Occupation(oc_orsinium_extremist, "Orsinium Extremist");
	static const auto strongholdShaman = Occupation(oc_stronghold_shaman, "Stronghold Shaman");
	...
	static const auto nordWarriorList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 15), stormcloak),
	...
	static const auto nordThiefList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 15), streetPerformer),
	...
	static const auto nordMageList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 15), priest),
	...
	static const auto imperialWarriorList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 39), imperialSoldier),
	...
	static const auto imperialMageList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 20), priest),
	...
	static const auto bretonWarriorList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 30), mercenary),
	...
	static const auto bretonThiefList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 30), thievesGuild),
	...
	static const auto bretonMageList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 30), priest),
	...
	static const auto dunmerWarriorList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 40), redoranGuard),
			OccupationRollMatcher(Domain::Range(41, 50), mercenary),
			OccupationRollMatcher(Domain::Range(51, 65), bountyHunter),
			OccupationRollMatcher(Domain::Range(66, 79), ashlander),
			OccupationRollMatcher(Domain::Range(80, 83), aspiringKnight),
			OccupationRollMatcher(Domain::Range(84, 86), hunter),
			OccupationRollMatcher(Domain::Range(87, 90), dawnguard),
			OccupationRollMatcher(Domain::Range(91, 92), arenaFighter),
			OccupationRollMatcher(Domain::Range(93, 98), bandit),
			OccupationRollMatcher(Domain::Range(99, 100), cityGuardRiften)
		};
	static const auto dunmerThiefList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 20), thievesGuild),
			OccupationRollMatcher(Domain::Range(21, 25), streetPerformer),
			OccupationRollMatcher(Domain::Range(26, 45), alchemist),
			OccupationRollMatcher(Domain::Range(45, 50), beggar),
			OccupationRollMatcher(Domain::Range(51, 60), bardsCollege),
			OccupationRollMatcher(Domain::Range(61, 67), bandit),
			OccupationRollMatcher(Domain::Range(68, 72), treasureHunter),
			OccupationRollMatcher(Domain::Range(73, 85), moragTong),
			OccupationRollMatcher(Domain::Range(86, 95), manualLaborer),
			OccupationRollMatcher(Domain::Range(96, 100), darkBrotherhood)
		};
	static const auto dunmerMageList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 30), priest),
			OccupationRollMatcher(Domain::Range(31, 40), courtWizard),
			OccupationRollMatcher(Domain::Range(41, 50), healer),
			OccupationRollMatcher(Domain::Range(51, 55), moragTong),
			OccupationRollMatcher(Domain::Range(56, 65), houseWizard),
			OccupationRollMatcher(Domain::Range(66, 70), archaeologist),
			OccupationRollMatcher(Domain::Range(71, 75), collegeStudent),
			OccupationRollMatcher(Domain::Range(76, 85), ashlander),
			OccupationRollMatcher(Domain::Range(86, 95), undertaker),
			OccupationRollMatcher(Domain::Range(96, 100), warlock)
		};

	static const auto altmerWarriorList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 40), thalmorSoldier),
			OccupationRollMatcher(Domain::Range(41, 50), mercenary),
			OccupationRollMatcher(Domain::Range(51, 65), aspiringKnight),
			OccupationRollMatcher(Domain::Range(66, 79), hunter),
			OccupationRollMatcher(Domain::Range(80, 83), dawnguard),
			OccupationRollMatcher(Domain::Range(84, 86), arenaFighter),
			OccupationRollMatcher(Domain::Range(87, 90), vigilant),
			OccupationRollMatcher(Domain::Range(91, 92), explorer),
			OccupationRollMatcher(Domain::Range(93, 98), bountyHunter),
			OccupationRollMatcher(Domain::Range(99, 100), companion)
		};
	static const auto altmerThiefList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 40), thalmorAgent),
			OccupationRollMatcher(Domain::Range(41, 45), thievesGuild),
			OccupationRollMatcher(Domain::Range(46, 48), streetPerformer),
			OccupationRollMatcher(Domain::Range(49, 58), alchemist),
			OccupationRollMatcher(Domain::Range(59, 64), mercenary),
			OccupationRollMatcher(Domain::Range(65, 75), bardsCollege),
			OccupationRollMatcher(Domain::Range(76, 85), investor),
			OccupationRollMatcher(Domain::Range(86, 90), manualLaborer),
			OccupationRollMatcher(Domain::Range(91, 96), treasureHunter),
			OccupationRollMatcher(Domain::Range(97, 100), darkBrotherhood)
		};
	static const auto altmerMageList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 23), thalmorWizard),
			OccupationRollMatcher(Domain::Range(24, 35), courtWizard),
			OccupationRollMatcher(Domain::Range(36, 40), healer),
			OccupationRollMatcher(Domain::Range(41, 43), aspiringCultist),
			OccupationRollMatcher(Domain::Range(44, 46), priest),
			OccupationRollMatcher(Domain::Range(47, 49), archaeologist),
			OccupationRollMatcher(Domain::Range(50, 64), collegeStudent),
			OccupationRollMatcher(Domain::Range(65, 81), summersetScholar),
			OccupationRollMatcher(Domain::Range(82, 90), undertaker),
			OccupationRollMatcher(Domain::Range(91, 100), warlock)
		};

	static const auto orsimerWarriorList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 31), strongholdGuard),
			OccupationRollMatcher(Domain::Range(32, 48), mercenary),
			OccupationRollMatcher(Domain::Range(49, 52), orsiniumExtremist),
			OccupationRollMatcher(Domain::Range(53, 64), arenaFighter),
			OccupationRollMatcher(Domain::Range(65, 71), dawnguard),
			OccupationRollMatcher(Domain::Range(72, 84), bountyHunter),
			OccupationRollMatcher(Domain::Range(85, 91), explorer),
			OccupationRollMatcher(Domain::Range(92, 97), bodyguard),
			OccupationRollMatcher(Domain::Range(98, 99), companion),
			OccupationRollMatcher(Domain::Range(100, 100), imperialSoldier)
		};
	static const auto orsimerThiefList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 20), skoomaSmuggler),
			OccupationRollMatcher(Domain::Range(21, 25), thievesGuild),
			OccupationRollMatcher(Domain::Range(26, 40), mercenary),
			OccupationRollMatcher(Domain::Range(41, 56), manualLaborer),
			OccupationRollMatcher(Domain::Range(57, 60), orsiniumExtremist),
			OccupationRollMatcher(Domain::Range(61, 67), bardsCollege),
			OccupationRollMatcher(Domain::Range(68, 72), streetPerformer),
			OccupationRollMatcher(Domain::Range(73, 85), treasureHunter),
			OccupationRollMatcher(Domain::Range(86, 90), darkBrotherhood),
			OccupationRollMatcher(Domain::Range(91, 100), alchemist)
		};
	static const auto orsimerMageList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 20), strongholdShaman),
			OccupationRollMatcher(Domain::Range(21, 30), warlock),
			OccupationRollMatcher(Domain::Range(31, 50), collegeStudent),
			OccupationRollMatcher(Domain::Range(51, 60), undertaker),
			OccupationRollMatcher(Domain::Range(61, 70), healer),
			OccupationRollMatcher(Domain::Range(71, 75), archaeologist),
			OccupationRollMatcher(Domain::Range(76, 80), imperialMage),
			OccupationRollMatcher(Domain::Range(81, 85), aspiringCultist),
			OccupationRollMatcher(Domain::Range(86, 95), priest),
			OccupationRollMatcher(Domain::Range(96, 100), dawnguard)
		};

	static const auto redguardWarriorList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 31), alikrWarrior),
			OccupationRollMatcher(Domain::Range(32, 48), mercenary),
			OccupationRollMatcher(Domain::Range(49, 52), explorer),
			OccupationRollMatcher(Domain::Range(53, 64), dawnguard),
			OccupationRollMatcher(Domain::Range(65, 71), cityGuard),
			OccupationRollMatcher(Domain::Range(72, 77), aspiringKnight),
			OccupationRollMatcher(Domain::Range(78, 85), bodyguard),
			OccupationRollMatcher(Domain::Range(86, 90), arenaFighter),
			OccupationRollMatcher(Domain::Range(91, 99), bandit),
			OccupationRollMatcher(Domain::Range(100, 100), stormcloak)
		};
	static const auto redguardThiefList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 30), thievesGuild),
			OccupationRollMatcher(Domain::Range(31, 40), streetPerformer),
			OccupationRollMatcher(Domain::Range(41, 50), alchemist),
			OccupationRollMatcher(Domain::Range(51, 55), beggar),
			OccupationRollMatcher(Domain::Range(56, 65), bardsCollege),
			OccupationRollMatcher(Domain::Range(66, 70), treasureHunter),
			OccupationRollMatcher(Domain::Range(71, 75), mercenary),
			OccupationRollMatcher(Domain::Range(76, 85), manualLaborer),
			OccupationRollMatcher(Domain::Range(86, 95), investor),
			OccupationRollMatcher(Domain::Range(96, 100), darkBrotherhood)
		};
	static const auto redguardMageList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 20), priest),
			OccupationRollMatcher(Domain::Range(21, 30), courtWizard),
			OccupationRollMatcher(Domain::Range(31, 45), healer),
			OccupationRollMatcher(Domain::Range(46, 60), vigilant),
			OccupationRollMatcher(Domain::Range(61, 70), stoneMage),
			OccupationRollMatcher(Domain::Range(71, 75), archaeologist),
			OccupationRollMatcher(Domain::Range(76, 80), collegeStudent),
			OccupationRollMatcher(Domain::Range(81, 85), dawnguard),
			OccupationRollMatcher(Domain::Range(86, 90), undertaker),
	...
	static const auto bosmerWarriorList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 31), hunter),
			OccupationRollMatcher(Domain::Range(32, 48), mercenary),
			OccupationRollMatcher(Domain::Range(49, 52), explorer),
			OccupationRollMatcher(Domain::Range(53, 64), woodsman),
			OccupationRollMatcher(Domain::Range(65, 73), lumberjack),
			OccupationRollMatcher(Domain::Range(74, 77), companion),
			OccupationRollMatcher(Domain::Range(78, 85), arenaFighter),
			OccupationRollMatcher(Domain::Range(86, 94), bandit),
			OccupationRollMatcher(Domain::Range(95, 99), redwaterDenGuard),
			OccupationRollMatcher(Domain::Range(100, 100), stormcloak)
		};
	static const auto bosmerThiefList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 15), manualLaborer),
			OccupationRollMatcher(Domain::Range(16, 25), skoomaSmuggler),
			OccupationRollMatcher(Domain::Range(26, 40), thievesGuild),
			OccupationRollMatcher(Domain::Range(41, 56), mercenary),
			OccupationRollMatcher(Domain::Range(57, 60), treasureHunter),
			OccupationRollMatcher(Domain::Range(61, 67), darkBrotherhood),
			OccupationRollMatcher(Domain::Range(68, 72), alchemist),
			OccupationRollMatcher(Domain::Range(73, 85), bardsCollege),
			OccupationRollMatcher(Domain::Range(86, 90), beggar),
			OccupationRollMatcher(Domain::Range(91, 100), streetPerformer)
		};
	static const auto bosmerMageList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 20), aspiringDruid),
			OccupationRollMatcher(Domain::Range(21, 30), priest),
			OccupationRollMatcher(Domain::Range(31, 45), healer),
			OccupationRollMatcher(Domain::Range(46, 60), archaeologist),
			OccupationRollMatcher(Domain::Range(61, 70), collegeStudent),
			OccupationRollMatcher(Domain::Range(71, 75), warlock),
			OccupationRollMatcher(Domain::Range(76, 80), courtWizard),
			OccupationRollMatcher(Domain::Range(81, 85), aspiringIllusionist),
			OccupationRollMatcher(Domain::Range(86, 90), undertaker),
			OccupationRollMatcher(Domain::Range(91, 100), aspiringCultist)
		};

	static const auto khajiitWarriorList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 28), caravanGuard),
			OccupationRollMatcher(Domain::Range(29, 48), mercenary),
			OccupationRollMatcher(Domain::Range(49, 59), explorer),
			OccupationRollMatcher(Domain::Range(60, 64), arenaFighter),
			OccupationRollMatcher(Domain::Range(65, 73), hunter),
			OccupationRollMatcher(Domain::Range(74, 77), redwaterDenGuard),
			OccupationRollMatcher(Domain::Range(78, 82), bountyHunter),
			OccupationRollMatcher(Domain::Range(83, 97), bandit),
			OccupationRollMatcher(Domain::Range(98, 99), vigilant),
			OccupationRollMatcher(Domain::Range(100, 100), companion)
		};
	static const auto khajiitThiefList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 15), skoomaSmuggler),
			OccupationRollMatcher(Domain::Range(16, 30), thievesGuild),
			OccupationRollMatcher(Domain::Range(31, 40), darkBrotherhood),
			OccupationRollMatcher(Domain::Range(41, 44), beggar),
			OccupationRollMatcher(Domain::Range(45, 60), caravanScout),
			OccupationRollMatcher(Domain::Range(61, 67), treasureHunter),
			OccupationRollMatcher(Domain::Range(68, 72), alchemist),
			OccupationRollMatcher(Domain::Range(73, 85), bandit),
			OccupationRollMatcher(Domain::Range(86, 95), mercenary),
			OccupationRollMatcher(Domain::Range(96, 100), bardsCollege)
		};
	static const auto khajiitMageList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 20), caravanMystic),
			OccupationRollMatcher(Domain::Range(21, 30), priest),
			OccupationRollMatcher(Domain::Range(31, 40), healer),
			OccupationRollMatcher(Domain::Range(41, 44), archaeologist),
			OccupationRollMatcher(Domain::Range(45, 60), collegeStudent),
			OccupationRollMatcher(Domain::Range(61, 70), warlock),
			OccupationRollMatcher(Domain::Range(71, 79), undertaker),
			OccupationRollMatcher(Domain::Range(80, 95), aspiringCultist),
			OccupationRollMatcher(Domain::Range(96, 98), courtWizard),
			OccupationRollMatcher(Domain::Range(99, 100), vigilant)
		};

	static const auto argonianWarriorList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 15), assemblageGuard),
			OccupationRollMatcher(Domain::Range(16, 30), mercenary),
			OccupationRollMatcher(Domain::Range(31, 40), explorer),
			OccupationRollMatcher(Domain::Range(41, 44), arenaFighter),
			OccupationRollMatcher(Domain::Range(45, 65), hunter),
			OccupationRollMatcher(Domain::Range(66, 67), vigilant),
			OccupationRollMatcher(Domain::Range(68, 72), bodyguard),
			OccupationRollMatcher(Domain::Range(73, 85), bountyHunter),
			OccupationRollMatcher(Domain::Range(86, 98), bandit),
			OccupationRollMatcher(Domain::Range(99, 100), companion)
	};
	static const auto argonianThiefList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 15), manualLaborer),
			OccupationRollMatcher(Domain::Range(16, 30), thievesGuild),
			OccupationRollMatcher(Domain::Range(31, 45), darkBrotherhood),
			OccupationRollMatcher(Domain::Range(46, 60), beggar),
			OccupationRollMatcher(Domain::Range(61, 70), bandit),
			OccupationRollMatcher(Domain::Range(71, 75), treasureHunter),
			OccupationRollMatcher(Domain::Range(76, 80), alchemist),
			OccupationRollMatcher(Domain::Range(81, 85), streetPerformer),
			OccupationRollMatcher(Domain::Range(86, 99), mercenary),
			OccupationRollMatcher(Domain::Range(100, 100), bardsCollege)
	};
	static const auto argonianMageList
		= OccupationRollList{
			OccupationRollMatcher(Domain::Range(1, 20), histMage),
			OccupationRollMatcher(Domain::Range(21, 30), aspiringIllusionist),
			OccupationRollMatcher(Domain::Range(31, 45), priest),
			OccupationRollMatcher(Domain::Range(46, 60), healer),
			OccupationRollMatcher(Domain::Range(61, 70), archaeologist),
			OccupationRollMatcher(Domain::Range(71, 75), collegeStudent),
			OccupationRollMatcher(Domain::Range(76, 80), undertaker),
			OccupationRollMatcher(Domain::Range(81, 85), aspiringCultist),
			OccupationRollMatcher(Domain::Range(86, 99), warlock),
			OccupationRollMatcher(Domain::Range(100, 100), courtWizard)
	};
...
void Domain::rollForEsCharSheet(const Types::WeakPtr<EsCharSheet>& weakPtr)
{
	const Types::SharedPtr<EsCharSheet> sheet = weakPtr.lock();
	if (sheet.isNull())
	{
	...
	const OccupationRollList& occupationRollList = getOccupationRollList(race, archetype);
